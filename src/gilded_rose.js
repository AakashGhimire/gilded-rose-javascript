...
// function update_quality() {
//   //if item name is not Brie, passes or sulfuras and quality is greater than 0, subtract quality by 1
...
//     //if items are not SULFURAs, decreasing items by 1 after each day
//     if (items[i].name != "Sulfuras, Hand of Ragnaros") {
